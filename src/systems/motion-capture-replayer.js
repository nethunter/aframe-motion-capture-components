AFRAME.registerSystem('motion-capture-replayer', {
  init: function () {
    ...
    trackedControlsTick =
      AFRAME.components['tracked-controls-webxr'].Component.prototype.tick;
    ...
    this.updateControllerListOriginal =
      trackedControlsSystem.updateControllerList.bind(trackedControlsSystem);
    this.throttledUpdateControllerListOriginal =
      trackedControlsSystem.throttledUpdateControllerList;
    trackedControlsSystem.throttledUpdateControllerList =
      this.updateControllerList.bind(this);
  ...
  remove: function () {
    ...
    trackedControlsComponent.tick =
      trackedControlsComponent.trackedControlsTick;
